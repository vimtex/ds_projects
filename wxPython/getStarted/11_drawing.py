...
class DoodleWindow(wx.Window):
    ...
    def initDrawing(self):
        ...
        self.currentThickness = self.thicknesses[2] 
        self.currentColour = self.colours[4]
        self.lines = []
    ...
    def onLeftDown(self, event):
       ...
       #self.previousPosition = event.GetPositionTuple()
        self.previousPosition = event.GetPosition()
        self.CaptureMouse()
    ...
    def drawLines(dc, *lines):
        ...
        x2, y2). '''
     #  Not available or needed after 2.8
     #  dc.BeginDrawing()
